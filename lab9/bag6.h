// Name: Jonathan Trinh (Johnny)
// FILE: bag6.h (part of the namespace scu_coen79_9)
...
namespace scu_coen79_9
{
    ...
    // Header file used: bintree.h
    {
        ...
        do
        {
            if (cursor->data( ) >= entry)       // if whatevery trying to insert <= to current
            {   // Go left
                if (cursor->left()==NULL) {
