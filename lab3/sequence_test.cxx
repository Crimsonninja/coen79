...
// An interactive test program for the new sequence class (official test file)
...
void print_menu();
// Postcondition: A menu of choices for this program has written to cout.
...
// Postcondition: The items on display have been printed out to cout (one per)
// line
	...
	do {
		...
		switch(choice) {
			...
			case 'R':	test.remove_current();
						...
						break;
			case 'Q':	cout << "Ridicule is the best of the truth." << endl;
						break;
...
char get_user_command() {
	...
	cout << "Enter choice: ";
	cin >> command;			// Input of characters skips blanks and newline characters
