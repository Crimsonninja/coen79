...
namespace coen79_lab6
{
    ...
    public:
        ...
        // const unsigned int polynomial::MAXIMUM_DEGREE = 50;
        ...
        // SETTER FUNCTIONS
        void set_coef_size(unsigned int number) {coef_size = number;}
        unsigned int get_coef_size() const { return coef_size; }
